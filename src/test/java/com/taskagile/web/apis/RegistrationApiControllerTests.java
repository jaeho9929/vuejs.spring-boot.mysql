...
public class RegistrationApiControllerTests {
  ...
  @Test
  public void register_blankPayload_shouldFailAndReturn400()
  throws Exception {
    // empty request body
  ...
  @Test
  public void register_existedUsername_shouldFailAndReturn400()
  throws Exception {
  ...
  @Test
  public void register_existedEmailAddress_shouldFailAndReturn400()
  throws Exception {
    RegistrationPayload payload = new RegistrationPayload();
  ...
  @Test
  public void register_validPayload_shouldSucceedAndReturn201()
  throws Exception {
    RegistrationPayload payload = new RegistrationPayload();
